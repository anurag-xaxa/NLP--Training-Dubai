...
import Valsakumar from '../assets/images/Valsakumar.jpg'
            ...
            <div className="founders">
                <div className="row">
                    ...
                    <div className="col-sm-4 col-md-6 col-lg-6">
                        ...
                        <p id="paragraph">VP has a Master’s in Business Administration &amp; is a Certified International Professional Training Consultant. He is an APICS CSCP and a Distinguished Toastmaster from Toastmasters International. He is also a Certified NLP Master Practitioner &amp; Coach, Certified NLP Trainer, Certified Group Coach , Certified Accelerated Learning Coach and a Certified Wellness Coach.</p>
                        <p id="paragraph">As Managing Partner of UV Consultants, VP today uses all his experience &amp; knowledge to do what he does best and what he is most passionate about, which is Training, Coaching and Consulting. VP is passionate about bringing out the best in people and helping individuals and organizations add value to whatever they do. He believes in an engaging, lively and practical approach to training and has a proven track record as an effective leader &amp; communicator.</p>
                        <p id="paragraph" >VP firmly believes that it’s never too late to start improving and adding value to your life and hence loves the quote from Carl Bard which says &#8220;Though no one can go back and make a brand new start, anyone can start from now and make a brand new ending&#8221;. He strongly believes in the power of sincerity and hence advocates the practice of living life sincerely. He has been living in Dubai, UAE since 1999.</p>
                    </div>
                </div>
            </div>
            <div className="founders">
                ...
                <div className="row">
                    ...
                    <p id="paragraph">
                        Our Courses and Programs are approved by ICF, International Coach Federation. As an accredited, ABNLP organization, our trainings and courses are run as per the Code of Ethics laid down by ABNLP, US – one of the most professional and trusted independent NLP membership organizations in the world.
                    </p>
                </div>
            </div>
        </>
